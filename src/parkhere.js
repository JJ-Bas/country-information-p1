...
if  (currencies.length === 1) {
    const  [{currencies: [{name: currencyName}]}] = onecurrency
} if (currencies.length === 2 ) {
    const [{currencies: [{name: currencyName},{name: currencyNameTwo}]}] = twocurrencies
}
